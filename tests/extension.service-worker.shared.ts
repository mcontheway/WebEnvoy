...
export const createEditorInputProbeResult = (overrides?: {
...
export const createChromeApi = (ports: ReturnType<typeof createMockPort>[]) => {
  let connectIndex = 0;
...
export const primeTrustedFingerprintContext = async (input: {
...
export const promoteBootstrapReadinessThroughPing = async (input: {
  runtimeMessageListeners: Array<
    (
      message: unknown,
      sender: { tab?: { id?: number; url?: string }; url?: string },
...
export const createApprovedReadApprovalRecord = () => ({
  approved: true,
...
export { startChromeBackgroundBridge };
