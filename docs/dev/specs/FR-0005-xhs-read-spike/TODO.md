...
- [x] `tested_head_sha=90e1a3f0ad2ca70ac10ffc91130d9c1dd4585c0a` 的 latest-head fresh rerun 已确认：`#445-A` 修复后的 `xhs.search` 不再出现 `executeXhsSearchImpl is not defined`
