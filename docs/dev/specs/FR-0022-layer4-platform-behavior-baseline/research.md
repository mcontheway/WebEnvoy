...
7. `profile_ref`、`effective_execution_mode` 与 `probe_bundle_ref` 仍属于 Layer 4 baseline identity；不同 recon/live scope 或不同 probe bundle 不得被折叠到同一条 Layer 4 baseline / assessment。
