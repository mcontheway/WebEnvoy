...
const runtimeXhsCloseoutValidationSource = async (context) => {
    ...
    try {
        ...
        store = runtimeStore;
        const { sessionId: rhythmSessionId, sessionRhythmWindowId, sessionRhythmDecisionId } = await resolveXhsCloseoutValidationSourceRhythm({
            store: runtimeStore,
            profile,
            sessionId: null,
